...
var resticsResource = schema.GroupVersionResource{Group: "vault.soter.ac", Version: "v1alpha1", Resource: "restics"}

var resticsKind = schema.GroupVersionKind{Group: "vault.soter.ac", Version: "v1alpha1", Kind: "Restic"}
...
func (c *FakeRestics) List(opts v1.ListOptions) (result *v1alpha1.ResticList, err error) {
	...
	list := &v1alpha1.ResticList{}
	for _, item := range obj.(*v1alpha1.ResticList).Items {
