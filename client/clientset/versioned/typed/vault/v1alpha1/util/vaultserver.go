...
func CreateOrPatchVaultServer(c cs.VaultV1alpha1Interface, meta metav1.ObjectMeta, transform func(alert *api.VaultServer) *api.VaultServer) (*api.VaultServer, kutil.VerbType, error) {
...
func PatchVaultServer(c cs.VaultV1alpha1Interface, cur *api.VaultServer, transform func(*api.VaultServer) *api.VaultServer) (*api.VaultServer, kutil.VerbType, error) {
	return PatchVaultServerObject(c, cur, transform(cur.DeepCopy()))
}

func PatchVaultServerObject(c cs.VaultV1alpha1Interface, cur, mod *api.VaultServer) (*api.VaultServer, kutil.VerbType, error) {
...
func TryUpdateVaultServer(c cs.VaultV1alpha1Interface, meta metav1.ObjectMeta, transform func(*api.VaultServer) *api.VaultServer) (result *api.VaultServer, err error) {
	attempt := 0
...
func UpdateVaultServerStatus(c cs.VaultV1alpha1Interface, cur *api.VaultServer, transform func(*api.VaultServerStatus) *api.VaultServerStatus, useSubresource ...bool) (*api.VaultServer, error) {
