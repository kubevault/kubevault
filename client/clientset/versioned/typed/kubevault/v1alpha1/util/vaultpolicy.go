...
func CreateOrPatchVaultPolicy(c cs.KubevaultV1alpha1Interface, meta metav1.ObjectMeta, transform func(alert *api.VaultPolicy) *api.VaultPolicy) (*api.VaultPolicy, kutil.VerbType, error) {
...
func PatchVaultPolicy(c cs.KubevaultV1alpha1Interface, cur *api.VaultPolicy, transform func(*api.VaultPolicy) *api.VaultPolicy) (*api.VaultPolicy, kutil.VerbType, error) {
	return PatchVaultPolicyObject(c, cur, transform(cur.DeepCopy()))
}

func PatchVaultPolicyObject(c cs.KubevaultV1alpha1Interface, cur, mod *api.VaultPolicy) (*api.VaultPolicy, kutil.VerbType, error) {
...
func TryUpdateVaultPolicy(c cs.KubevaultV1alpha1Interface, meta metav1.ObjectMeta, transform func(*api.VaultPolicy) *api.VaultPolicy) (result *api.VaultPolicy, err error) {
	attempt := 0
