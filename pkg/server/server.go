...
import (
	...
	"github.com/soter/vault-operator/apis/extensions/install"
	"github.com/soter/vault-operator/apis/extensions/v1alpha1"
	"github.com/soter/vault-operator/pkg/controller"
	snapregistry "github.com/soter/vault-operator/pkg/registry/vaultsecret"
...
func (c completedConfig) New() (*StashServer, error) {
	...
	{
		apiGroupInfo := genericapiserver.NewDefaultAPIGroupInfo(extensions.GroupName, registry, Scheme, metav1.ParameterCodec, Codecs)
		apiGroupInfo.GroupMeta.GroupVersion = v1alpha1.SchemeGroupVersion
		v1alpha1storage := map[string]rest.Storage{}
		v1alpha1storage[v1alpha1.ResourcePluralVaultSecret] = snapregistry.NewREST(c.ExtraConfig.ClientConfig)
