...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RetryJoinSpec) DeepCopyInto(out *RetryJoinSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RetryJoinSpec.
func (in *RetryJoinSpec) DeepCopy() *RetryJoinSpec {
	if in == nil {
		return nil
	}
	out := new(RetryJoinSpec)
	in.DeepCopyInto(out)
	return out
}
