...
> Note: YAML files used in this tutorial stored in [examples](/docs/examples/guides/secret-engins/mongodb) folder in github repository [KubeVault/docs](https://github.com/kubevault/docs)
...
```console
$ kubectl apply -f examples/guides/secret-engins/mongodb/storageClass.yaml 
...
```console
$ kubectl apply -f examples/guides/secret-engins/mongodb/pvc.yaml 
...
```console
$ kubectl apply -f examples/guides/secret-engins/mongodb/pod.yaml 
pod/mypod created
```
