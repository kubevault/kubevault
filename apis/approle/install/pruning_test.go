...
import (
	...
	"kubevault.dev/operator/apis/approle/fuzzer"
	"kubevault.dev/operator/apis/approle/v1alpha1"
...
func TestPruneTypes(t *testing.T) {
	...
	// CRD v1
	if crd := (v1alpha1.VaultAppRole{}).CustomResourceDefinition(); crd.V1 != nil {
		crdfuzz.SchemaFuzzTestForV1CRD(t, clientsetscheme.Scheme, crd.V1, fuzzer.Funcs)
	}

	// CRD v1beta1
	if crd := (v1alpha1.VaultAppRole{}).CustomResourceDefinition(); crd.V1beta1 != nil {
