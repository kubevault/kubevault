...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRole":                   schema_operator_apis_approle_v1alpha1_VaultAppRole(ref),
		"kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleList":               schema_operator_apis_approle_v1alpha1_VaultAppRoleList(ref),
		"kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleSpec":               schema_operator_apis_approle_v1alpha1_VaultAppRoleSpec(ref),
		"kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleStatus":             schema_operator_apis_approle_v1alpha1_VaultAppRoleStatus(ref),
	}
}
...
func schema_operator_apis_approle_v1alpha1_VaultAppRole(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleSpec", "kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRoleStatus"},
	}
}

func schema_operator_apis_approle_v1alpha1_VaultAppRoleList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRole"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubevault.dev/operator/apis/approle/v1alpha1.VaultAppRole"},
	}
}

func schema_operator_apis_approle_v1alpha1_VaultAppRoleSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "More info: https://www.vaultproject.io/api-docs/auth/approle",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vaultRef": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"vaultRef", "bindSecretID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference"},
...
func schema_operator_apis_approle_v1alpha1_VaultAppRoleStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
