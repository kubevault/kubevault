...
func schema_operator_apis_core_v1alpha1_VaultServerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kubevault/operator/apis/core/v1alpha1.BackendStorageSpec", "github.com/kubevault/operator/apis/core/v1alpha1.TLSPolicy", "github.com/kubevault/operator/apis/core/v1alpha1.UnsealerSpec", "k8s.io/api/core/v1.VolumeSource", "kmodules.xyz/offshoot-api/api/v1.PodTemplateSpec", "kmodules.xyz/offshoot-api/api/v1.ServiceTemplateSpec"},
	}
}
