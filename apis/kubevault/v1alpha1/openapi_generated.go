...
func schema_operator_apis_kubevault_v1alpha1_VaultServerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"kmodules.xyz/client-go/api/v1.Condition", "kubevault.dev/operator/apis/kubevault/v1alpha1.AuthMethodStatus", "kubevault.dev/operator/apis/kubevault/v1alpha1.VaultStatus"},
	}
}
