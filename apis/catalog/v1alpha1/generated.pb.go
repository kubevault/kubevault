...
/*
	...
	It is generated from these files:
		kubevault.dev/operator/apis/catalog/v1alpha1/generated.proto

	It has these top-level messages:
		VaultServerVersion
		VaultServerVersionExporter
		VaultServerVersionList
		VaultServerVersionSpec
		VaultServerVersionUnsealer
		VaultServerVersionVault
*/
package v1alpha1
...
func (*VaultServerVersion) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{0} }
...
func (*VaultServerVersionList) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{2} }

func (m *VaultServerVersionSpec) Reset()                    { *m = VaultServerVersionSpec{} }
func (*VaultServerVersionSpec) ProtoMessage()               {}
func (*VaultServerVersionSpec) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{3} }
...
func (*VaultServerVersionVault) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{5} }
...
func (m *VaultServerVersionSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintGenerated(dAtA, i, uint64(m.Vault.Size()))
	n4, err := m.Vault.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	...
	n5, err := m.Unsealer.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
	...
	n6, err := m.Exporter.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n6
...
func (this *VaultServerVersionList) String() string {
	...
	s := strings.Join([]string{`&VaultServerVersionList{`,
		...
		`Items:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Items), "VaultServerVersion", "VaultServerVersion", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() {
	proto.RegisterFile("kubevault.dev/operator/apis/catalog/v1alpha1/generated.proto", fileDescriptorGenerated)
}
